...
//    var deviceModel by remember { mutableStateOf<PhoneSpecs?>(null) }
...
//                            val rep = Repair(null, insertVm.customerId, newDeviceId, 1, insertVm.price.toDoubleOrNull() ?: 0.0, "", repairType = insertVm.selectedType)
